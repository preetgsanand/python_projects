...
class Job(models.Model):
	...
	jobemployee = models.ManyToManyField(Employee,null=True,blank=True)
...
class Report(models.Model):
	...
	reportType = models.IntegerField(choices=((1, "Public"),
                                        (2, "Private")),
                                default=2)
	sender = models.ForeignKey(Entity, on_delete=models.CASCADE)
	reciever = models.ForeignKey(Entity, on_delete=models.CASCADE,related_name='+',blank=True,null=True)
